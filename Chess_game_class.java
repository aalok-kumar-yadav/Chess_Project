...
public class Chess_game_class {//game class 
	static char you_r_not[][]=new char[8][8];
		public static void main(String arg[]){//main method defined
			Scanner input=new Scanner(System.in);
			 Chess_board_class object_board=new Chess_board_class();//board class composition
	...
	System.out.println("Enter source's 'x' cordinate ");//taking source coordinate(x1,y1) form from user
	    ...
	    Chess_user_class usr_obj=new Chess_user_class();  //composition of user class object making
