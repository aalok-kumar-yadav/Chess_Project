...
public class Chess_user_class {  //user class invoked
	...
	public boolean start(int U,int x1,int y1,int x2,int y2,char ty){ //start method in user class
		...
		Chess_piece_class us_obj=new Chess_piece_class();  //Board class composition in this class
		Chess_board_class bo_obj=new Chess_board_class();
