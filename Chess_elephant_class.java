...
public interface Chess_elephant_class {

	default boolean move_e(int us,int x1,int y1,int x2,int y2,char ty){ //move_e method defined here
		
		Chess_board_class temp_object=new Chess_board_class(); //making composition of board class
	...
	default boolean change_status_e(int usr,int x1,int y1,int x2,int y2,char ty,int count,char array_2d_piece2[][]){
		...
		Chess_board_class change_object=new Chess_board_class();
